...
export function Footer() {
  const mapsUrl =
    "https://www.google.com/maps/search/?api=1&query=Via+Nazionale+221%2FV,+54011+Aulla+MS,+Italy";
  const fullAddress =
    "VIA NAZIONALE 221/V PRESSO CONDOMINIO LA PIRAMIDE, 54011 AULLA (MS)";
    ...
    <footer className="bg-blue-950 text-white">
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
        ...
        >
          {/* Sede */}
          <div>
            <h3 className="text-lg font-semibold mb-3 text-white text-left">
              Sede
            </h3>
            <a
              href={mapsUrl}
            ...
            >
              ...
              <span>
                VIA NAZIONALE 221/V PRESSO CONDOMINIO LA PIRAMIDE, 54011 AULLA
                (MS)
              </span>
            </a>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-gray-300 font-geist-sans text-sm md:text-base">
              ...
              <a
                href="mailto:imprefondamato@gmail.com"
                className="hover:text-blue-200 transition-colors flex items-center gap-2"
              >
          ...
          <div>
            ...
            <a
              href="mailto:imprefond@pec.it"
              className="hover:text-blue-200 transition-colors flex items-center gap-2 text-gray-300 font-geist-sans text-sm md:text-base"
            >
        ...
        >
          <p>
            &copy; {new Date().getFullYear()} IMPREFOND F.LLI AMATO SRL. Tutti i
            diritti riservati.
          </p>
